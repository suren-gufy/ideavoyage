...
export const analysisResponseSchema = z.object({
  ...
  data_source: z.enum(["synthetic_only", "ai_synthetic", "mixed_real_synthetic", "real_reddit_data", "limited_real", "reddit_plus_ai"]).optional(),
  analysis_confidence: z.enum(["demo_mode", "ai_enhanced", "premium_enhanced", "low", "medium", "high"]).optional(),
